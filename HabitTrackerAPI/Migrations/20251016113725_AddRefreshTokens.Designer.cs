...
namespace HabitTrackerAPI.Migrations
{
    ...
    [Migration("20251016113725_AddRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HabitTrackerAPI.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HabitTrackerAPI.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HabitTrackerAPI.Models.DailyItem", b =>
                {
                    b.HasOne("HabitTrackerAPI.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HabitTrackerAPI.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
